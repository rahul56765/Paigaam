...
<meta name="description" content="Because some things deserve more. Create a beautiful digital Paigaam for the people and moments that matter.">
<meta property="og:title" content="${esc(title)} — Paigaam">
<meta property="og:description" content="Because some things deserve more.">
  ...
  <div class="wrap">
    <div class="footer__grid">
      <div class="footer__brand">
        ...
        <p>Because some things deserve more.</p>
      </div>
      <div>
        <h4>Explore</h4>
        <ul>
...
(function () {
  ...
  /* Live template thumbnails: iframe a full render at miniature width, then drift it
     slowly from top to bottom in a loop. Starts only when visible; pauses offscreen;
  ...
  document.querySelectorAll('.tcard__live').forEach(function (frame) {
    ...
    frame.addEventListener('load', function () { fit(); frame.classList.add('is-ready'); });
