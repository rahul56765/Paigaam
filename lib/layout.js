...
function nav(current = '') {
  ...
  <div class="wrap nav__inner">
    <a href="/" class="nav__brand" aria-label="Paigaam home">
      <span style="width:42px;display:inline-block">${doveSVG('#8F1018', 'width="100%" class="nav__logo-img"')}</span>
      <span class="nav__word">PAIGAAM</span>
    </a>
...
function footer() {
  ...
  <div class="wrap">
    ...
    <div class="footer__base">
      ...
      <span style="width:34px;display:inline-block">${doveSVG('#A8917E', 'width="100%"')}</span>
    </div>
  </div>
</footer>`;
}
...
<main class="empty">
  <div class="dove">${doveSVG('#8F1018', 'width="100%"')}</div>
