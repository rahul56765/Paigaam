'use strict';
/**
 * Validation for Love Awaits personalisation.
 *
 * Every field is optional except the recipient's name — an untouched form
 * still produces the designed proposal, because the renderer supplies the
 * defaults. Stored data is always a clean, whitelisted object: unknown keys
 * never persist.
 */
