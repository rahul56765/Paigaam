...
module.exports = {
  ...
  demo: {
    ...
    story: [
      { date: 'March 2023', title: 'Pehli chai, pehli baat', caption: 'You were twenty minutes late, and I pretended to be annoyed for exactly two of them.', photo: '/assets/bfday-demo/couple-1.jpg' },
      { date: 'June 2023', title: 'The first long drive', caption: 'Wrong turn, right playlist. We got lost for an hour and it was the best hour of the month.', photo: '/assets/bfday-demo/couple-2.jpg' },
      { date: 'December 2023', title: 'Meeting the family', caption: 'You brought my mother flowers and my brother a cricket bat. Both of them still ask about you.', photo: '/assets/bfday-demo/couple-4.jpg' },
      { date: 'Today', title: 'Still my favourite person', caption: 'And somehow, a little more every day.', photo: '/assets/bfday-demo/couple-8.jpg' },
    ],
    reasonsOn: 'show',
    reasons: REASONS,
    together: '2023-03-11',
    ...
    gallery: [
      { photo: '/assets/bfday-demo/couple-6.jpg', caption: 'Goa, the trip we almost missed' },
      { photo: '/assets/bfday-demo/couple-7.jpg', caption: 'Your birthday cake disaster' },
      { photo: '/assets/bfday-demo/couple-5.jpg', caption: 'Marine Drive at midnight' },
      { photo: '/assets/bfday-demo/couple-9.jpg', caption: 'Us, being us' },
    ],
    songTitle: 'Tum Se Hi — Mohit Chauhan',
